...
const AddCircle = () => {
  ...
  const circle = useSelector(store => store.circles.circleForm.circle);
    ...
    <Card className={classes.card}>
      <form onSubmit={handleSubmit(onSubmit)}>
        <input
          ...
          name="id"
          value={circle ? circle.id : uuid.v4()}
        />
        <input
          readOnly
          className={classes.input}
        ...
        <CardContent className={classes.cardContent}>
          <Grid
            container
            direction="column"
            className={activeStep === 0 ? classes.inputBox : classes.input}
          >
            <Grid item>
            ...
            <Grid item>
              <TextField
                ...
                placeholder="Smith Inner Circle"
                variant="outlined"
              />
            </Grid>
            <Grid item>
              <Typography variant="h6">
                Enter a description for your Circle below
              </Typography>
            </Grid>
            <Grid item>
              <TextField
          ...
          <Grid
            ...
            justify="center"
            alignItems="center"
            className={activeStep === 1 ? classes.inputBox : classes.input}
          >
            <Grid item>
              <Typography variant="h5">
                Click on the image below to upload a banner image for your
                Circle
              </Typography>
            </Grid>
            <Grid item>
          ...
          <Grid
            ...
            justify="flex-start"
            alignItems="stretch"
            className={activeStep === 2 ? classes.inputBox : classes.input}
          >
            <Grid item>
              <Typography variant="h5">
                Search and select members to join your circle
              </Typography>
            </Grid>
            <Grid item>
              <ChipInput
                ...
                onDelete={chip =>
                  setCurrentMembers(currentMembers.filter(x => x !== chip))
                }
            ...
            <Grid item>
              <ChipInput
                ...
                onDelete={chip =>
                  setCurrentAdmins(currentAdmins.filter(x => x !== chip))
                }
          ...
          <Grid
            ...
            justify="flex-start"
            alignItems="stretch"
            className={activeStep === 3 ? classes.inputBox : classes.input}
          >
            <Grid item>
              <Typography variant="h5">
